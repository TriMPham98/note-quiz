...
// Sample student data (now hardcoded instead of fetched from API)
const sampleStudents = [
  { id: 1, first_name: "John", last_name: "Doe", score: 10 },
  { id: 2, first_name: "Jane", last_name: "Smith", score: 15 },
  { id: 3, first_name: "Bob", last_name: "Johnson", score: 12 },
  { id: 4, first_name: "Alice", last_name: "Williams", score: 18 },
  { id: 5, first_name: "Charlie", last_name: "Brown", score: 8 },
];
  ...
  const endGame = useCallback(() => {
    ...
    if (mode === "practice") {
      ...
      if (accuracy >= 90 && score > selectedStudent.score) {
        // Update score locally instead of using an API
        setFeedback(
          `Congratulations, ${
        ...
        setStudents((prevStudents) =>
          prevStudents.map((student) =>
            student.id === selectedStudent.id ? { ...student, score } : student
          )
        );
